...
const products = [
    ...
    },
    {
        ...
        name: "Musc Solide",
        price: 100,
        image: "assets/img/Musc_solide.jpg",
...
parfumsFemme.forEach(name => {
    products.push({
        ...
        price: 100,
        image: "assets/img/huile_femme.jpg",
...
parfumsHomme.forEach(name => {
    products.push({
        ...
        name: "Huile de Parfum - " + name,
        price: 100,
        image: "assets/img/huile_homme.jpg",
        description: "Extrait de parfum haute qualité. Longue tenue garantie (concentré).",
        category: "parfums",
        subCategory: "homme",
        colors: []
